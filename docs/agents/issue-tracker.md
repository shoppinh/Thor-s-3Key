...
External pull requests are not treated as a request surface for triage. Triage issues
and PRDs only unless the repo owner explicitly asks to include PRs.
